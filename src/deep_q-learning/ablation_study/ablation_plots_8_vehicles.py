"""
ablation_plots_8_vehicles.py: plots results in results/ablation_study/.
...
def plot_ablation(rows, ablation_name):
    ...
    fig.suptitle(
        f"Ablation (8 vehicles): {ablation_name}", fontsize=14, fontweight="bold"
    )
    ...
    plt.tight_layout()
    path = os.path.join(OUTPUT_DIR, f"ablation_{ablation_name}_8_vehicles.png")
...
def main():
    ...
    print("All 8-vehicle ablation plots generated.")
